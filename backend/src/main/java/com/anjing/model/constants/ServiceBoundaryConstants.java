...
public final class ServiceBoundaryConstants {
    ...
    public static final class Test {
        ...
        public static final String[] ROUTES = { "health", "features", "ping", "businessException", "systemException", "items", "itemDetail", "ragDemoSeed", "ragDemoRetrievalEvaluation", "ragDemoEvidenceReport" };
    ...
    public static final class Knowledge {
        ...
        public static final String[] ROUTES = { "listKnowledgeBases", "listAllKnowledgeBases", "knowledgeBaseDetail", "knowledgeBaseDocuments", "knowledgeBaseDocumentsBatchUpload", "documentDetail", "documentBatchDelete", "documentEnabled", "documentReprocess", "documentTasks", "documentChunks", "documentChunkCount", "chunkDetail", "chunkEnabled" };
