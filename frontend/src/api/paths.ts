...
export const ApiPaths = {
  ...
  knowledge: {
    bases: SERVICE_BOUNDARY_ROUTE_PATHS.knowledge.bases,
    basesAll: SERVICE_BOUNDARY_ROUTE_PATHS.knowledge.basesAll,
    baseDetail: (kbId: string | number) =>
    ...
    documentEnabled: (docId: string | number) =>
    ...
    documentChunkCount: (docId: string | number) =>
      bindApiPathParams(SERVICE_BOUNDARY_ROUTE_PATHS.knowledge.documentChunkCount, { docId }),
    chunkDetail: (chunkId: string | number) =>
      bindApiPathParams(SERVICE_BOUNDARY_ROUTE_PATHS.knowledge.chunkDetail, { chunkId }),
    chunkEnabled: (chunkId: string | number) =>
  ...
  chat: {
    conversations: SERVICE_BOUNDARY_ROUTE_PATHS.chat.conversations,
    conversationDetail: (conversationId: string | number) =>
      bindApiPathParams(SERVICE_BOUNDARY_ROUTE_PATHS.chat.conversationDetail, { conversationId }),
    conversationTitle: (conversationId: string | number) =>
      bindApiPathParams(SERVICE_BOUNDARY_ROUTE_PATHS.chat.conversationTitle, { conversationId }),
    messages: (conversationId: string | number) =>
      bindApiPathParams(SERVICE_BOUNDARY_ROUTE_PATHS.chat.messages, { conversationId })
  }
} as const
