...
export const SERVICE_BOUNDARY_CONTRACT = {
  ...
  "boundaries": [
    ...
    {
      "id": "test",
      "name": "Agent Knowledge Test",
      "kind": "sample",
      "owner": "agent-knowledge",
      "currentHost": "agent-knowledge",
      "basePath": "/api/test",
      ...
      "openapi": true,
      "copyAction": "keep as local smoke endpoints or remove after real health endpoints are ready",
      "routes": [
        {
          "name": "health",
        ...
        {
          "name": "ragDemoRetrievalEvaluation",
          "backendConstant": "RAG_DEMO_RETRIEVAL_EVALUATION_FULL",
          "frontendKey": "ragDemoRetrievalEvaluation",
    ...
    },
    {
      ...
      "apiPathsKey": "common",
      "openapi": false,
      "copyAction": "keep only endpoints implemented by agent-knowledge",
      "routes": [
        {
          "name": "upload",
    ...
    },
    {
      ...
      "apiConstantsClass": "Knowledge",
      "apiPathsKey": "knowledge",
      "controller": "backend/src/main/java/com/anjing/knowledge/controller/KnowledgeBaseController.java",
      "openapi": true,
      "copyAction": "core RAG knowledge management boundary",
      "routes": [
        {
          "name": "listKnowledgeBases",
          "backendConstant": "BASES_FULL",
          "frontendKey": "bases",
        ...
        },
        {
          ...
          "backendConstant": "BASES_ALL_FULL",
          "frontendKey": "basesAll",
        ...
        },
        {
          ...
          "backendConstant": "BASE_DETAIL_FULL",
          "frontendKey": "baseDetail",
        ...
        },
        {
          ...
          "backendConstant": "BASE_DOCUMENTS_FULL",
          "frontendKey": "baseDocuments",
        ...
        {
          "name": "documentBatchDelete",
          "backendConstant": "DOCUMENT_BATCH_DELETE_FULL",
          "frontendKey": "documentBatchDelete",
        ...
        },
        {
          ...
          "backendConstant": "DOCUMENT_ENABLED_FULL",
          "frontendKey": "documentEnabled",
        ...
        {
          "name": "documentReprocess",
          "backendConstant": "DOCUMENT_REPROCESS_FULL",
          "frontendKey": "documentReprocess",
        ...
        {
          "name": "documentChunkCount",
          "backendConstant": "DOCUMENT_CHUNK_COUNT_FULL",
          "frontendKey": "documentChunkCount",
        ...
        {
          "name": "chunkDetail",
          "backendConstant": "CHUNK_DETAIL_FULL",
          "frontendKey": "chunkDetail",
        ...
        {
          "name": "chunkEnabled",
          "backendConstant": "CHUNK_ENABLED_FULL",
          "frontendKey": "chunkEnabled",
    ...
    },
    {
      ...
      "owner": "agent-knowledge",
      "currentHost": "agent-knowledge",
      "basePath": "/api/retrieval",
      "apiConstantsClass": "Retrieval",
      "apiPathsKey": "retrieval",
      "controller": "backend/src/main/java/com/anjing/knowledge/controller/RetrievalController.java",
      "openapi": true,
      "copyAction": "core RAG search and context assembly boundary",
      "routes": [
        {
          "name": "search",
          "backendConstant": "SEARCH_FULL",
          "frontendKey": "search",
    ...
    },
    {
      ...
      "currentHost": "agent-knowledge",
      "basePath": "/api/chat",
      "apiConstantsClass": "Chat",
      "apiPathsKey": "chat",
      "controller": "backend/src/main/java/com/anjing/chat/controller/ChatController.java",
      "openapi": true,
      "copyAction": "core RAG answer generation and citation boundary",
      "routes": [
        {
          "name": "conversations",
          "backendConstant": "CONVERSATIONS_FULL",
          "frontendKey": "conversations",
        ...
        },
        {
          ...
          "backendConstant": "CONVERSATION_DETAIL_FULL",
          "frontendKey": "conversationDetail",
        ...
        },
        {
          ...
          "backendConstant": "CONVERSATION_TITLE_FULL",
          "frontendKey": "conversationTitle",
        ...
        {
          "name": "messages",
          "backendConstant": "MESSAGES_FULL",
          "frontendKey": "messages",
...
export const SERVICE_BOUNDARY_ROUTE_PATHS = {
  ...
  "chat": {
    ...
    "conversationTitle": "/api/chat/conversations/{conversationId}/title",
  ...
  "knowledge": {
    ...
    "chunkEnabled": "/api/knowledge/chunks/{chunkId}/enabled",
    "documentBatchDelete": "/api/knowledge/documents/batch-delete",
    "documentChunkCount": "/api/knowledge/documents/{docId}/chunks/count",
