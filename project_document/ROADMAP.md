...
- 检索已具备 score 解释、本地 hybrid retrieval、本地 keyword provider、本地 lexical rerank、远程 rerank provider 边界、demo recall@K 评测闭环和前端质量评测面板；后续继续补 BM25/Elasticsearch adapter。
