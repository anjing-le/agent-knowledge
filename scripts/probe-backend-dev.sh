...
TMP_ROOT="${TMPDIR:-/tmp}"
LOG_FILE="$TMP_ROOT/agent-knowledge-backend-probe.$PORT.log"
PID_FILE="$TMP_ROOT/agent-knowledge-backend-probe.$PORT.pid"
HEALTH_FILE="$TMP_ROOT/agent-knowledge-backend-health.$PORT.json"
FEATURES_FILE="$TMP_ROOT/agent-knowledge-backend-features.$PORT.json"
OPENAPI_FILE="$TMP_ROOT/agent-knowledge-backend-openapi.$PORT.json"
...
assert(openapi.info?.title === 'Anjing Agent Knowledge API', 'OpenAPI title mismatch')
